...
public class leftVoiceChannelListener extends ListenerAdapter{
	...
	public void onGuildVoiceLeave(GuildVoiceLeaveEvent e) {
		...
		eb.setDescription(user.getAsMention() + " has disconnected of " + voiceChannel.getName() + " voice channel.\n"
