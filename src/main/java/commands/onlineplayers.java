...
public class onlineplayers {
	...
	public void onlineplayersMethod(User user, Message message) {
		...
		try {
    		...
    		eb.setDescription("There are " + onlinePlayers + "/" + maxPlayers + " players connected!\n_Join our server!_\nIP: **play.mazikro.com**");
    		...
    		// A baix del títol - text informatiu
    		eb.setDescription("Server is currently offline.");
